...
require_once CONFIG_ROOT . '/file_upload.php';
...
class AppPost {
    ...
    private static function required(array $key, $from)
    {
        foreach($key as $k) {
    ...
    public static function checkProgressAccount(string $userid) {
    ...
    public function isAllowToEdit(int $status) {
    ...
    public function getRegency($data, $user) {
        $db = Database::connect();
        $progressAccount = self::checkProgressAccount(md5(md5($user['MBR_ID'])));
        ...
        $sqlGet = $db->query("SELECT KDP_KABKO FROM tb_kodepos WHERE UPPER(KDP_PROV) = UPPER('{$province}') GROUP BY KDP_KABKO ORDER BY KDP_KABKO");
    ...
    public static function getDistrict($data, $user) {
    ...
    public function createDemo($data, $user) {
        ...
        // if(!empty($demoAccount) && $mbrid != '1746678318') {
        //     exit(json_encode([
        //         'success'   => false,
        //         'error'     => "Sudah memiliki akun demo"
        //     ]));
        // }
        ...
        if(is_array($lgn)){
            exit(json_encode([
                'success'   => false,
                'error'     => $lgn['message'] ?? $lgn['error'] ?? "Gagal membuat akun demo, Respons tidak valid"
            ]));
        }
        ...
        if($sqlGetType->num_rows == 0 || $demoType == 0) {
            exit(json_encode([
                'success'   => false,
                'error'     => "Gagal membuat akun demo, Jenis akun tidak valid"
            ]));
        }
        ...
        if(!$sqlInsertDemo->execute()) {
            exit(json_encode([
                'success'   => false,
                'error'     => "Gagal menyimpan akun demo"
            ]));
        }
    ...
    public function accountType($data, $user) {
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/profile-perusahaan",
            'alert'     => [
                'title' => "Berhasil",
    ...
    public function profilePerusahaan($data, $user) {
        ...
        $ipAddress = $helperClass->get_ip_address();
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/pernyataan-simulasi",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Successfull",
                'icon'  => "success"
    ...
    public function pernyataanSimulasi($data, $user) {
        ...
        if(empty($progressAccount['ACC_F_SIMULASI_IMG'])) {
            ...
            $uploadFile = upload_myfile($_FILES['smls_demofile'], "demo_img_");
        ...
        /** Update tb_racc */
        $updateRacc = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_SIMULASI'        => 1,
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/pernyataan-pengalaman",
            'alert'     => [
                'title' => "Berhasil",
    ...
    public function pernyataanPengalaman($data, $user) {
        ...
        loadModel("Helper");
        $helperClass = new Helper();
        $update = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_PENGLAMAN'       => 1,
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/pernyataan-pengungkapan-1",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil disimpan",
                'icon'  => "success"
    ...
    public function pernyataanPengungkapan_1($data, $user) {
        ...
        $update = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_DISC'        => 1,
            'ACC_F_DISC_IP'     => $helperClass->get_ip_address(),
            'ACC_F_DISC_PERYT'  => "Ya",
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/aplikasi-pembukaan-rekening",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil disimpan",
                'icon'  => "success"
    ...
    public function pernyataanPengungkapan_2($data, $user) {
        ...
        $update = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_DISC2'        => 1,
            'ACC_F_DISC_IP2'     => $helperClass->get_ip_address(),
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/formulir-dokumen-resiko",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil disimpan",
                'icon'  => "success"
    ...
    public function pernyataanPengungkapan_3($data, $user) {
        ...
        $update = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_DISC3'        => 1,
            'ACC_F_DISC_IP3'     => $helperClass->get_ip_address(),
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/perjanjian-pemberian-amanat",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil disimpan",
                'icon'  => "success"
    ...
    public function pernyataanPengungkapan_4($data, $user) {
        ...
        $update = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_DISC4'        => 1,
            'ACC_F_DISC_IP4'     => $helperClass->get_ip_address(),
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/verifikasi-identitas",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil disimpan",
                'icon'  => "success"
    ...
    public function aplikasiPembukaanRekening($data, $user) {
        ...
        loadModel("Helper");
        $helperClass = new Helper();
        $helperClass->updateWithArray("tb_racc", [
            'ACC_F_APP' => 1,
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/pernyataan-pengungkapan-2",
            'alert'     => [
                'title' => "Berhasil",
    ...
    private function aplikasiPembukaanRekening_DataPribadi($data, $user, $progressAccount) {
        ...
        loadModel("Helper");
        $helperClass = new Helper();
        $updateDataPribadi = $helperClass->updateWithArray("tb_racc", [
    ...
    private function aplikasiPembukaanRekening_PihakDarurat($data, $user, $progressAccount) {
        ...
        loadModel("Helper");
        $helperClass = new Helper();
        $updatePihakDarurat = $helperClass->updateWithArray("tb_racc", [
    ...
    private function aplikasiPembukaanRekening_Pekerjaan($data, $user, $progressAccount) {
        ...
        loadModel("Helper");
        $helperClass = new Helper();
        $updatePekerjaan = $helperClass->updateWithArray("tb_racc", [
    ...
    private function aplikasiPembukaanRekening_DaftarKekayaan($data, $user, $progressAccount) {
        ...
        loadModel("Helper");
        $helperClass = new Helper(); 
        $updateKekayaan = $helperClass->updateWithArray("tb_racc", [
    ...
    private function aplikasiPembukaanRekening_DokumenPendukung($data, $user, $progressAccount) {
        ...
        if(empty($_FILES['app_pendukung']) || $_FILES['app_pendukung']['error'] != 0) {
            ...
            $uploadDokumenPendukung = upload_myfile($_FILES['app_pendukung'], "regol");
        ...
        if(empty($_FILES['app_pendukung_lainnya']) || $_FILES['app_pendukung_lainnya']['error'] != 0) {
            ...
            $uploadDokumenPendukung2 = upload_myfile($_FILES['app_pendukung_lainnya'], "regol");
    ...
    public function formulirDokumenResiko($data, $user) {
        ...
        $update = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_RESK' => 1,
            'ACC_F_RESK_PERYT' => "Ya" ,
            'ACC_F_RESK_IP' => $helperClass->get_ip_address(),
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/pernyataan-pengungkapan-3",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil Disimpan",
                'icon'  => "success"
    ...
    public function perjanjianPemberianAmanat($data, $user) {
        ...
        $update = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_PERJ' => 1,
            'ACC_F_PERJ_IP' => $helperClass->get_ip_address(),
            'ACC_F_PERJ_PERYT' => "Ya",
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/peraturan-perdagangan",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil disimpan",
                'icon'  => "success"
    ...
    public function peraturanPerdagangan($data, $user) {
        ...
        $update = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_TRDNGRULE' => 1,
            'ACC_F_TRDNGRULE_IP' => $helperClass->get_ip_address(),
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/pernyataan-bertanggung-jawab",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil disimpan",
                'icon'  => "success"
    ...
    public function pernyataanBertanggungJawab($data, $user) {
        ...
        $update = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_KODE' => 1,
            'ACC_F_KODE_IP' => $helperClass->get_ip_address(),
            'ACC_F_KODE_PERYT' => "Ya",
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/pernyataan-dana-nasabah",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil disimpan",
                'icon'  => "success"
    ...
    public function pernyataanDanaNasabah($data, $user) {
        ...
        $update = $helperClass->updateWithArray("tb_racc", [
            'ACC_F_DANA' => 1,
            'ACC_F_DANA_IP' => $helperClass->get_ip_address(), 
            'ACC_F_DANA_PERYT' => "Ya",
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/pernyataan-pengungkapan-4",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil disimpan",
                'icon'  => "success"
    ...
    public function verifikasiIdentitas($data, $user) {
        ...
        if($statusVerifikasiVerihub != $progressAccount['ACC_DOC_VERIF']) {
            loadModel("Helper");
            $helperClass = new Helper();
            $update = $helperClass->updateWithArray("tb_racc", ['ACC_DOC_VERIF' => $statusVerifikasiVerihub], ['ID_ACC' => $progressAccount['ID_ACC']]);
            if($update !== TRUE) {
                exit(json_encode([
                    'success'   => false,
                    'alert'     => [
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/kelengkapan-formulir",
            'alert'     => [
                'title' => "Berhasil",
                'text'  => "Berhasil disimpan",
                'icon'  => "success"
    ...
    public function depositNewAccount($data, $user) {
        ...
        exit(json_encode([
            'success'   => true,
            'redirect'  => "/create-acc/deposit-new-account",
            'alert'     => [
                'title' => "Berhasil",
...
try {
    $appPost    = new AppPost($db, $IP_ADDRESS);
    $method     = $_POST['method'] ?? $_GET['method'] ?? "error"; 
    
    /** Check Session & Cookie */
    $hashId     = $_SESSION['user']['id'] ?? $_COOKIE['id'] ?? "-";
    $hashEmail  = $_SESSION['user']['email'] ?? $_COOKIE['x'] ?? "-";

    $sqlGetUser = $db->query("SELECT * FROM tb_member WHERE MD5(MD5(MBR_ID)) = '{$hashId}' AND MD5(MD5(MBR_EMAIL)) = '{$hashEmail}' LIMIT 1");
    $user = $sqlGetUser->fetch_assoc();
    if($sqlGetUser->num_rows != 1) {
        logout();
        exit(json_encode([
            'success'   => false,
            'alert'     => [
