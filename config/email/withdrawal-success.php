                            ...
                            <div align="center" style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;text-align:center">
                                ...
                                <tbody>
                                    ...
                                    <td align="center" valign="middle" style="padding:0px;margin:0px;font-size:0px;width:56px">
                                        <img alt="" width="61" height="61" style="display:block;border:0;outline:none;text-decoration:none" src="https://client-rrfx.techcrm.net/assets/images/check.png" class="CToWUd" data-bit="iit">
                                    </td>
                                    </tr>
                                </tbody>
                                </table>
