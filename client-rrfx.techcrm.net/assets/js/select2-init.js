(function($) {
    ...
    $(document).ready(function() {
        ...
        $('select.form-control.select2').on('select2:open', function(){
        ...
        if($('.digi-dataTable').length) {
            $('.digi-dataTable').on('draw.dt', function() {
                $(this).find('select.form-control.select2').select2({
                    minimumResultsForSearch: -1,
                    containerCssClass: ':all:',
                    placeholder: function(){
                        $(this).data('placeholder');
                ...
                $(this).find('select.form-control.select2').on('select2:open', function(){
                    if($('body').hasClass('modal-open')) {
                        $('.select2-dropdown').addClass('select2-in-modal');
                    } else {
                        $('.select2-dropdown').removeClass('select2-in-modal');
