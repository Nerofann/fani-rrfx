        ...
        <div class="modal-content">
            <form method="post" id="accounting-form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" value="accept" class="btn btn-success act-acc">Accept</button>
                    <button type="button" value="reject" class="btn btn-danger act-acc">Reject</button>
                </div>
            </form>
        </div>
...
<script>
    $(document).ready(() => {
        ...
        $('#accounting-form').on('submit', function(e){
            ...
            $.post("/ajax/post/transaction/withdrawal_accounting", data, function(resp) {
