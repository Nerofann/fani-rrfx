            ...
            <table class="table no-border" style="margin-top: 20px; font-size: 15px;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="3%" class="v-align-top">:</td>
                        <td class="v-align-top" style="border-bottom: 1px solid black !important;">(Rp <?= formatCurrency($amountIDR, 0) ?>)</td>
                    </tr>
                    <tr>
                        <td width="30%" class="v-align-top">Terbilang</td>
                        <td width="3%" class="v-align-top">:</td>
                        <td class="v-align-top" style="border-bottom: 1px solid black !important;"><?= $helperClass->penyebut(intval($amountIDR)) ?></td>
                    </tr>
                </tbody>
            </table>
                            ...
                            <table class="table" style="font-size: 15px; border: 1px solid black;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="border: 1px solid black !important;" width="20%" class="v-align-top" align="right">
                                            <p style="margin-top: 0px; text-align: right;">
                                                <?= formatCurrency($amountIDR) ?>
                                            </p>    
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid black !important;" colspan="2" class="text-center">Total</td>
                                        <td style="text-align: right; border: 1px solid black !important">Rp <?= formatCurrency($amountIDR) ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
